...
import name.vanillaminus.screen.DirtCrafterScreenHandler;
...
public class DirtCrafterBlock extends Block {
    private static final Text TITLE = Text.translatable("container.crafting");

    public DirtCrafterBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
